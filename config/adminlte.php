    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'url'  => 'escolas',
            'icon' => false,
            'can' => 'gerenciar escolas'
        ],
        [
            'text' => 'Alunos',
            'url'  => 'alunos',
            'icon' => false,
            'can' => 'gerenciar alunos'
        ],
        [
            'text' => 'Diretores',
            'url'  => 'diretores',
            'icon' => false,
            'can' => 'gerenciar diretores'
        ],
        // [
        //     'text' => 'Secretários',
        //     'url'  => 'secretarios',
        //     'icon' => false,
        //     'can' => 'gerenciar secretarios'
        // ],
        [
            'text' => 'Tipos de Ocorrência',
            'url'  => 'tipos_ocorrencia',
            'icon' => false,
            'can' => 'gerenciar tipos_ocorrencia'
        ],
        [
            'text' => 'Medidas',
            'url' => 'medidas',
            'icon'    => false,
            'can' => 'gerenciar medidas'
        ],
        [
            'text'    => 'Ocorrências',
            'icon'    => false,
            'can' => 'gerenciar ocorrencias',
            'submenu' => [
                [
